...
const selects = document.querySelectorAll("select");
  ...
  // Criando objeto com as linguagens do Tradutor.
const countries = {
  "en-GB": "Inglês",
  "es-ES": "Espanhol",
  "it-IT": "Italiano",
...
selects.forEach((tag) => {
  for (let country in countries) {
   ...
   // Valida se o campo de texto contem string. Se sim, retorna a função LoadTranslation, se nao, retorna vazio 
